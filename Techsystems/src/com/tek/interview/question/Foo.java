...
class calculator {
	 ...
	 */
	public static double calculate(Map<String, Order> o) {
		...
		for (Map.Entry<String, Order> entry : o.entrySet()) {
			...
			for (int i = 0; i < r.size(); i++) {
				...
				double totalprice = (r.get(i).getItem().getPrice() + rounding(tax)) *r.get(i).getQuantity();
